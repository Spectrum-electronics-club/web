      ...
      <div style={{ background: '#070b11', minHeight: '100vh' }}>
        <section style={{ position: 'relative', padding: '7rem 0 3rem', overflow: 'hidden' }}>
          <div className="container-main" style={{ position: 'relative', zIndex: 1 }}>
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
              <p style={{ color: '#06b6d4', fontSize: '0.75rem', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.12em', marginBottom: '1rem' }}>Research & Writings</p>
              ...
              <p style={{ color: '#94a3b8', maxWidth: '480px', lineHeight: 1.75 }}>
                Technical papers, research articles, and knowledge contributions from Spectrum members.
              </p>
            </motion.div>
          </div>
        </section>
        ...
        <section style={{ padding: '2rem 0 6rem' }}>
          <div className="container-main">
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.5rem', marginBottom: '2.5rem' }}>
                {allTags.map(t => (
                  <button key={t} onClick={() => setTag(t)} style={{
                    ...
                    background: tag===t ? 'rgba(6,182,212,0.1)' : 'transparent',
                    borderColor: tag===t ? 'rgba(6,182,212,0.4)' : 'rgba(255,255,255,0.08)',
            ...
            {!loading && !error && filtered.map((pub) => (
              <div key={pub._id} style={{ marginBottom: '1rem' }}>
