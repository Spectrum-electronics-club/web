          ...
          <div style={{ gridColumn: 'span 2 / span 2' }}>
            <Link to="/" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.75rem', textDecoration: 'none', marginBottom: '1rem' }}>
              <div style={{ display: 'flex', gap: '0.4rem' }}>
                {/* Logo 1 */}
                {logo1 && (
                  <img src={logo1} alt="Logo 1" style={{ width: 'auto', height: '64px', borderRadius: '10px', objectFit: 'contain', filter: 'brightness(1.4) drop-shadow(0 0 12px rgba(255,255,255,0.6))' }} />
                )}
                {logo2 && (
                  <img src={logo2} alt="Logo 2" style={{ width: 'auto', height: '64px', borderRadius: '10px', objectFit: 'contain', filter: 'brightness(1.4) drop-shadow(0 0 12px rgba(255,255,255,0.6))' }} />
                )}
              </div>
              <span style={{
