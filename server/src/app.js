...
// ── Public rate limiter (1 min window) ───────────────────────────────────
const publicLimiter = rateLimit({
  windowMs: 1 * 60 * 1000,
  max: 50, // Increased to 50 to prevent blocking normal navigation
  keyGenerator: (req) => {
...
app.use('/api/v1/announcements', publicLimiter, announcementsRoutes)
